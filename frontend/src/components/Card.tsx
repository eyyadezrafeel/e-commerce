...
const Card = () => {
  ...
  return (
    ...
    <div className="flex flex-col items-center w-[100vw] h-[100vh] bg-[#000000]  ">
      ...
      {products.map((p) => ( 
        <div className="min-w-[20vw] max-w-[25vw]  bg-[#000000] border border-[#B3001B] shadow rounded-lg p-4 flex flex-col justify-between flex-shrink-0 hover:scale-105 transform transition" key={p.id}>
